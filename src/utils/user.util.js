...
*/
  ...
  verifyHandleRentAction = Joi.object({
    ...
    page: Joi.number().integer().required(),
    type: Joi.string()
      .valid("recentRent", "tenantInvoicesDue")
      .required()
      .label("Type"),
  });
  ...
  verifyHandleSendInvoce = Joi.object({
    userId: Joi.number().required(),
    role: Joi.string().valid("list", "rent", "admin", "super_admin").required(),
    userIdList: Joi.array().items(Joi.number().integer().required()).required(),
  });
  ...
  verifyHandleGetChat = Joi.object({
    userId: Joi.number().required(),
    role: Joi.string().valid("list", "rent", "admin", "super_admin").required(),
    type: Joi.string().valid("summary", "chatDetail").required().label("Type"),
    partnerId: Joi.number().when("type", {
      is: "chatDetail",
      then: Joi.required(),
      otherwise: Joi.forbidden(),
    }),
  ...
  verifyHandleInspectionAction = Joi.object({
    ...
    inspectionMode: Joi.string().valid("inPerson", "videoChat").when("type", {
      is: "createInspection",
      then: Joi.required(),
      otherwise: Joi.forbidden(),
    }),
    ...
    gender: Joi.string().valid("Male", "Female").when("type", {
      is: "createInspection",
      then: Joi.required(),
      otherwise: Joi.forbidden(),
    }),
  ...
  verifyHandleGetBuildingDetails = Joi.object({
    userId: Joi.number().required(),
    role: Joi.string().valid("rent", "super_admin").required(),
  ...
  verifyHandleGetBuildings = Joi.object({
    ...
    propertyLocation: Joi.string().when("type", {
      is: "all",
      then: Joi.optional(),
    }),
    propertyPreference: Joi.string().when("type", {
      is: "all",
      then: Joi.optional(),
    }),
    furnishingStatus: Joi.string()
      .valid("furnished", "unfurnished", "partly furnished", "unset")
      .when("type", { is: "all", then: Joi.optional() }),
    bedrooms: Joi.number()
      .integer()
      .when("type", { is: "all", then: Joi.optional() }),
    amenities: Joi.array()
  ...
  verifyHandleQuitNoticeAction = Joi.object({
    type: Joi.string()
      .valid("send", "acknowledged", "get", "delete")
      .required(),
    userId: Joi.number().integer().required(),
    role: Joi.string().valid("list", "rent", "admin", "super_admin").required(),
...
*/
  ...
  verifyHandleUpdatelistedBuilding = Joi.object({
    ...
    titles: Joi.alternatives()
      ...
      .optional(),
    widths: Joi.alternatives()
      .try(Joi.string(), Joi.array().items(Joi.string().regex(/^\d+$/)))
      .optional(),
    lengths: Joi.alternatives()
      .try(Joi.string(), Joi.array().items(Joi.string().regex(/^\d+$/)))
      .optional(),
  ...
  */
  ...
  verifyHandleListBuilding = Joi.object({
    ...
    numberOfRooms: Joi.number().integer().required(),
    amenity: Joi.array().items(Joi.string()).required(),
    availability: Joi.string().valid("vacant", "occupied").required(),
    furnishingStatus: Joi.string()
      .valid("furnished", "unfurnished", "partly furnished")
      .required(),
    rentalDuration: Joi.number().integer().required(),
