...
*/
  ...
  async updatelistedBuilding(req, res, next) {
    try {
      ...
      data.buildingOccupantPreference = data.buildingOccupantPreference
        ? JSON.parse(data.buildingOccupantPreference)
        : null;
  ...
  */
  ...
  async getBuildings(req, res, next) {
    try {
      ...
      const response = await userService.handleGetBookedBuildingsTenant(my_bj);
  ...
  async BuildingPreferenceAction(req, res, next) {
    try {
      const data = req.body;
  ...
  async validateNIN(req, res, next) {
    try {
      const data = req.body;
