...
export default class AuthenticationController {
  ...
  async authorizeTransfer(req, res, next) {
    try {
  ...
  async webHookMonifyDisbursement(req, res, next) {
    try {
  ...
  async webHookMonifyRefund(req, res, next) {
    try {
  ...
  async webHookCollectionMonify(req, res, next) {
    try {
  ...
  async intializePayment(req, res, next) {
    try {
      const data = req.body;
  ...
  async validateBankAccount(req, res, next) {
    try {
      const data = req.body;
  ...
  async getMaritalStatus(req, res, next) {
    try {
  ...
  async getReligion(req, res, next) {
    try {
...
*/
  ...
  validateTransactionHash = (req, res, next) => {
    try {
      ...
      if (!monnifySignature) {
        console.log("Missing Monnify signature");
        console.log(monnifySignature);
        console.log("Missing Monnify signature");
        return res.status(400).send("Missing Monnify signature");
      }
