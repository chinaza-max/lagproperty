      ...
      .map(
        (landlord) => `
          <tr>
            ...
            <td>
              <a data-id="${landlord.id}"   type="button" class="btn btn-primary view-landlord-btn">View</a>
            </td>
          </tr>`
      )
      .join("");
...
/*
  ...
  document.getElementById('settingsForm').addEventListener('submit', function(e) {
      ...
      const preferences = {};
      document.querySelectorAll('#preferencesTable tr').forEach((row, index) => {
      ...
      const settings = {
          ...
          appPercentage: parseFloat(document.getElementById('appPercentage').value),
          accountNumber: document.getElementById('accountNumber').value,
          failedDisburseRetry: parseInt(document.getElementById('failedDisburseRetry').value),
          failedRefundRetry: parseInt(document.getElementById('failedRefundRetry').value),
          pendingDisburseRetry: parseInt(document.getElementById('pendingDisburseRetry').value),
          pendingDisburseRentRetry: parseInt(document.getElementById('pendingDisburseRentRetry').value),
          appShare: parseInt(document.getElementById('appShare').value),
          preferences: preferences,
          notificationAllowed: document.getElementById('notificationAllowed').checked
      };
